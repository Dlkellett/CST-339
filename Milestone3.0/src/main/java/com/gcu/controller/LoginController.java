...
public class LoginController 
{
	...
	public String doLogin(@Valid LoginModel loginModel, BindingResult bindingResult, Model model)
	{
		...
		if (trueUsername.toLowerCase().trim().equals("james") && truePassword.toLowerCase().trim().equals("gwozdz"))
		{
		...
		// This will be if the login was successful 
		if (trueUsername.toLowerCase().trim().equals("dylan") && truePassword.toLowerCase().trim().equals("kellett"))
		{
			model.addAttribute("title", "Login Success! Welcome in!");
			return "loginSuccess";
		}
